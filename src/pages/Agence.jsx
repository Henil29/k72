  ...
  return (
    <div className='bg-black'>
      <div className='section1 py-1 text-white'>
        <div ref={imageDivRef} className='absolute overflow-hidden lg:h-[18vw] lg:w-[14vw] h-[200px] w-[150px] lg:rounded-3xl rounded-4xl lg:top-50 top-40 lg:left-[30vw] left-[20vw] '>
        ...
        <div className='relative font-[font2]'>
          ...
          <div className='lg:pl-[45%] p-5 text-right mt-20'>
            <p className='lg:text-5xl text-xl'> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Notre curiosité nourrit notre créativité. On reste humbles et on dit non aux gros egos, même le vôtre. Une marque est vivante. Elle a des valeurs, une personnalité, une histoire. Si on oublie ça, on peut faire de bons chiffres à court terme, mais on la tue à long terme. C’est pour ça qu’on s’engage à donner de la perspective, pour bâtir des marques influentes.</p>
          </div>
        </div>
      </div>
